...
#mkdir log
#mkdir jobs
mkdir /eos/cms/store/group/phys_heavyions/xiaoyul/wenbin/Playground
...
do
    ...
    python3 ./grid_Submit.py $ii 1 1 # !!! 60 is the number of tasks, 100000 is the number of events in each output. Total number of events is 60^2*100000 !!!
